      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="space-y-6 h-[calc(100vh-200px)]">
            ...
            {/* Bottom Half - Schedule and Repository - ORIGINAL CLEAN FORMAT */}
            <div className="h-1/2">
              <Tabs defaultValue="schedule" className="h-full flex flex-col">
                ...
                {/* Kitchen Schedule Tab - ORIGINAL DETAILED FORMAT */}
                <TabsContent value="schedule" className="flex-1 mt-4">
                  <Card className="h-full flex flex-col">
                    ...
                    <CardContent className="flex-1 overflow-auto p-4">
                      {/* Team-based scheduling grid - ORIGINAL FORMAT */}
                      <div className="overflow-x-auto">
                        <div className="min-w-[800px]">
                          {/* Grid header with time slots */}
                          <div className="grid grid-cols-5 gap-2 mb-4">
                            <div className="font-medium text-center bg-muted p-2 rounded">
                              Team / Time
                            </div>
                            {TIME_SLOTS.map(slot => (
                              <div key={slot} className="font-medium text-center bg-muted p-2 rounded text-sm">
                                {slot}
                              </div>
                            ))}
                          </div>
                                      ...
                                      <div className="space-y-1">
                                        ...
                                        {assignedDemo.recipes.length > 0 && (
                                          <div className="text-xs text-muted-foreground">
                                            ...
                                            {assignedDemo.recipes.length > 2 && ` +${assignedDemo.recipes.length - 2}`}
                                          </div>
                                        )}
                                      </div>
                                    ) : (
                ...
                {/* Recipe Repository Tab - ORIGINAL FORMAT */}
