    ...
    <div className="min-h-screen bg-background">
                              ...
                              {TEAM_GROUPS.map((team) => {
                                ...
                                return (
                                  ...
                                  >
                                    {assignedDemo ? (
                                      <div 
                                        className="bg-blue-50 border border-blue-200 rounded px-2 py-1 text-xs cursor-pointer hover:bg-blue-100 transition-colors min-h-[3rem] flex flex-col justify-center"
                                      ...
                                      >
                                        ...
                                        <div className={`text-xs px-1 py-0.5 rounded mt-1 ${getStatusColor(assignedDemo.leadStatus)}`}>
                                          {assignedDemo.leadStatus === 'demo_given' ? '✓' : '⏳'}
                                        </div>
                                      </div>
                                    ) : (
                                      <div className="min-h-[3rem] flex items-center justify-center text-muted-foreground text-xs">
                                        {user.role === 'head_chef' ? 'Drop here' : 'Available'}
                                      </div>
                                    )}
                                  </td>
                                );
      ...
      {showDemoDetail && selectedDemo && (
        <DemoDetailModal
          ...
          canEdit={user.role === 'presales' || user.role === 'head_chef'}
        />
      )}
