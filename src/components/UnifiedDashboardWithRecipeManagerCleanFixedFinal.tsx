...
export function UnifiedDashboard({
  ...
  return (
    <>
          ...
          <div className="space-y-6 h-[calc(100vh-200px)]">
            ...
            <div className="h-1/2">
              ...
              >
                ...
                {/* Kitchen Schedule Tab - PRESERVING ORIGINAL FORMAT */}
                <TabsContent
                  value="schedule"
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          >
                            ...
                            <option value="my_demos">
                              My Demos ({scheduleStats.myDemos})
                            </option>
                      ...
                      {filteredSchedule.length === 0 ? (
                        <div className="text-center py-12 text-muted-foreground">
                          ...
                          <p className="text-sm mt-2">
                            {user.role === "head_chef"
                              ? "Drag demos from the 'Ready for Assignment' section above to schedule them"
                              : "Demos will appear here once they are scheduled by the head chef"}
                          </p>
                        </div>
                      ) : (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                          {TEAM_GROUPS.map((team) => (
                            ...
                            >
                              <div className="font-medium text-center bg-white py-3 rounded border">
                                {team.name}
                ...
                {/* Recipe Repository Tab - PRESERVING ORIGINAL FORMAT */}
                <TabsContent
                  value="recipes"
                  className="flex-1 overflow-hidden"
                >
      ...
      {/* MODAL COMPONENTS - THE CRITICAL FIX */}
      <DemoDetailModal
        demo={selectedDemo}
